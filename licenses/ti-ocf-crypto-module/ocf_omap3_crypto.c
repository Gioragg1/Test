...
int ocf_omap3_crypto_process(device_t arg, struct cryptop *crp, int hint)
{
    ...
    int *id_list = (int *)sid, i, hash_len = 0;
    omap3_crypto_process_fptr process_fptr = NULL;
    omap3_crypto_process_dma_fptr process_dma_fptr = NULL;
